...
toolchain_table = [
    ...
    Toolchain('android-ndk-r13b-api-21-armeabi-v7a-neon', 'Unix Makefiles'),
    Toolchain('android-ndk-r13b-api-21-arm64-v8a', 'Unix Makefiles'),
...
if platform.system() == 'Darwin':
  toolchain_table += [
      ...
      Toolchain('ios-nocodesign-12-2-dep-9-3-arm64', 'Xcode', ios_version='12.2', nocodesign=True),
      Toolchain('ios-nocodesign-12-2-dep-9-3-armv7', 'Xcode', ios_version='12.2', nocodesign=True),
      Toolchain('ios-nocodesign-12-2-dep-9-3-armv7s', 'Xcode', ios_version='12.2', nocodesign=True),
      Toolchain('ios-nocodesign-12-2-dep-9-3-x86_64', 'Xcode', ios_version='12.2', nocodesign=True),
      Toolchain('ios-nocodesign-12-2-dep-9-3-i386', 'Xcode', ios_version='12.2', nocodesign=True),
...
if os.name == 'posix':
  toolchain_table += [
      ...
      Toolchain('gcc-pic', 'Unix Makefiles'),
      Toolchain('gcc-5-pic', 'Unix Makefiles'),
