...
if(DEFINED POLLY_IOS_NOCODESIGN_12_2_DEP_9_3_64_CMAKE_)
  return()
else()
  set(POLLY_IOS_NOCODESIGN_12_2_DEP_9_3_64_CMAKE_ 1)
endif()
...
polly_init(
    "iOS ${IOS_SDK_VERSION} / Deployment ${IOS_DEPLOYMENT_SDK_VERSION} / universal 64 / \
